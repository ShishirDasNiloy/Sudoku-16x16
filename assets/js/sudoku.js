...
// checking repetition in 4x4 box
...
// checking repetition row, column and 4x4 boxs
const isSafe = (grid, row, col, value) => {
    return isColSafe(grid, col, value) && isRowSafe(grid, row, value) && isBoxSafe(grid, row - row%4, col - col%4, value) && value !== CONSTANT.UNASSIGNED;
}
...
// checking the puzzle complet or not
...
// removing cells from the created sudoku board
...
// show sukoku board based on level
